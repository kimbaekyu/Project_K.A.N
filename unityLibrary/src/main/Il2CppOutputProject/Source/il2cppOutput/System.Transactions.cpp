...
{
	{
		...
		bool L_1;
		L_1 = Transaction_op_Inequality_mE3037727A1FCA9BD4B9324591D33D14496575B4E(L_0, (Transaction_tB36D4D179023FCFA37362B3BC0C4DC533D2EE1AD*)NULL, NULL);
		if (!L_1)
		{
			goto IL_0020;
		}
...
void AsyncCommit_Invoke_mAB6911D77D96EB8FAA0E2EE3FA1E3DCE323A528E_Open(AsyncCommit_t71DC723123EBA5C843539A11885B9B64FBA2FF0D* __this, const RuntimeMethod* method)
{
...
IL2CPP_EXTERN_C IL2CPP_METHOD_ATTR void AsyncCommit__ctor_mBC316513E94C120C9626641E149466A8D0FCD0CF (AsyncCommit_t71DC723123EBA5C843539A11885B9B64FBA2FF0D* __this, RuntimeObject* ___object0, intptr_t ___method1, const RuntimeMethod* method) 
{
	...
	if (MethodIsStatic((RuntimeMethod*)___method1))
	{
		...
		if (il2cpp_codegen_call_method_via_invoker((RuntimeMethod*)___method1))
			...
			if (isOpen)
				__this->___invoke_impl_1 = (intptr_t)&AsyncCommit_Invoke_mAB6911D77D96EB8FAA0E2EE3FA1E3DCE323A528E_Open;
			else
				{
					__this->___invoke_impl_1 = (intptr_t)__this->___method_ptr_0;
					__this->___method_code_6 = (intptr_t)__this->___m_target_2;
